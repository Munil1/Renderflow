...
public class GLRR {
	...
	public void Begin(GLTask task) {
		switch(task) {
			case GLTask.LINES: gl.glBegin(GL_LINES); break;
			case GLTask.QUADS: gl.glBegin(GL_QUADS); break;
			case GLTask.TRIANGLES: gl.glBegin(GL_TRIANGLES); break;
			case GLTask.POLYGON: gl.glBegin(GL_POLYGON); break;
		}
	}
	//Util methods
